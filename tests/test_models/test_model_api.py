...
class TestModelAPI:
    def test_model_names_raul_net(self):
        ...
        model_data = [
            ...
            for p in Path("../../doc_octopy/models/definitions/raul_net").rglob("*.py")
        ...
        for model_type, model_name in model_data:
            try:
                imported_module = importlib.import_module(
                    f"doc_octopy.models.definitions.raul_net.{model_type}.{model_name}"
                )
                ...
                pytest.fail(
                    f"Could not import doc_octopy.models.definitions.raul_net.{model_type}.{model_name}"
                )
